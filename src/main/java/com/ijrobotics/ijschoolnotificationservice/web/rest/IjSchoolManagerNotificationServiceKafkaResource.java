...
@RestController
@RequestMapping("/api/ij-school-manager-notification-service-kafka")
public class IjSchoolManagerNotificationServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(IjSchoolManagerNotificationServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public IjSchoolManagerNotificationServiceKafkaResource(KafkaProperties kafkaProperties) {
