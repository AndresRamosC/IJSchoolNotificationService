...
/**
 * REST controller for managing {@link com.ijrobotics.ijschoolnotificationservice.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
public class NotificationResource {
    ...
    private static final String ENTITY_NAME = "ijSchoolManagerNotificationServiceNotification";
