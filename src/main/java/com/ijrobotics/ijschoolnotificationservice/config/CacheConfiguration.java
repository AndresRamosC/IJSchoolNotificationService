...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("IJSchoolManagerNotificationService");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("IJSchoolManagerNotificationService");
        ...
        config.getMapConfigs().put("com.ijrobotics.ijschoolnotificationservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
