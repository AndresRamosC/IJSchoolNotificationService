...
import com.ijrobotics.ijschoolnotificationservice.config.KafkaProperties;
...
class IjSchoolManagerNotificationServiceKafkaResourceIT {
    ...
    void setup() {
        ...
        IjSchoolManagerNotificationServiceKafkaResource kafkaResource = new IjSchoolManagerNotificationServiceKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/ij-school-manager-notification-service-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/ij-school-manager-notification-service-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
